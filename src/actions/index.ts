...
// NOTES (SEC 7):
// We dont need to use this file as being server file as this file has no access to the window object and new version of auth requires access to the window object.
